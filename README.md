...
- **Java Fluent API version** (`*Example.java`) — strongly-typed record I/O, graph built with `Graph.builder()`
...
| Example | Files | What it shows |
|---|---|---|
| Spring Boot starter | `integration/spring/*.java` \| `bloge/integration/spring/spring-ticket-triage.bloge` \| `integration/spring-boot-example/application.yml` | `@BlogeOperator` bean discovery, classpath DSL loading, a demo REST controller, and `/actuator/bloge` diagnostics inside a Spring Boot app |
...
| Maven plugin profile | `integration/maven/MavenPluginExample.java` \| `bloge/integration/plugin/metadata-catalog.bloge` \| `plugin-example.blogerc.json` | The `bloge-plugin-example` Maven profile for `export-metadata` and `lint`, scoped to a clean DSL catalog |
...
The following 5 examples demonstrate the core capabilities of sub-graphs: nested execution, parallel sub-graphs, branching into sub-graphs, and sub-graph output aggregation.
...
- **Demonstrates:** implicit variables `item`, `item.field`, and `itemIndex`, parallel foreach, and downstream nodes consuming foreach output
...
onNodeSuspended("awaitUserInput") fires         // listener notifies the main thread
...
├── batch-order-parallel.bloge       — foreach parallel batch orders
...
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.ecommerce.OrderProcessingExample" \
  -Dexec.args="" \
...
```bash
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.ecommerce.OrderProcessingDslExample"
```

### Running BPMN → DSL examples

```bash
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.bpmn.BpmnToDslExample"
```

### Running beginner and integration examples

```bash
# Beginner quickstarts
mvn exec:java -pl bloge-examples -Dexec.mainClass="com.leanowtech.bloge.examples.beginner.HelloWorldExample"
mvn exec:java -pl bloge-examples -Dexec.mainClass="com.leanowtech.bloge.examples.beginner.TwoNodeChainDslExample"
mvn exec:java -pl bloge-examples -Dexec.mainClass="com.leanowtech.bloge.examples.beginner.ErrorHandlingShowcaseExample"

# Spring Boot starter sample
mvn exec:java -pl bloge-examples -Dexec.mainClass="com.leanowtech.bloge.examples.integration.spring.SpringBootTicketTriageApplication"

# Manual observability wiring
mvn exec:java -pl bloge-examples -Dexec.mainClass="com.leanowtech.bloge.examples.integration.observability.ObservabilityExample"

# Maven plugin integration
mvn -pl bloge-maven-plugin,bloge-examples -am -Pbloge-plugin-example verify
```

### Running BFF examples

```bash
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.bff.BffAggregationExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.bff.BffAggregationDslExample"
```

### Running Sub-Graph examples

```bash
# E-commerce — end-to-end order pipeline
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.ecommerce.OrderFullPipelineExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.ecommerce.OrderFullPipelineDslExample"

# Finance — full loan approval flow
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.finance.LoanApprovalSubGraphExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.finance.LoanApprovalSubGraphDslExample"

# Customer service — smart ticket handling
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.customerservice.SmartTicketHandlingExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.customerservice.SmartTicketHandlingDslExample"

# Logistics — international shipment flow
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.logistics.InternationalShipmentExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.logistics.InternationalShipmentDslExample"

# Catering — end-to-end restaurant order flow
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.catering.RestaurantOrderPipelineExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.catering.RestaurantOrderPipelineDslExample"
```


### Running Iteration examples (foreach & loop)

```bash
# Parallel batch order processing — ForEach (parallel)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.iteration.BatchOrderParallelExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.iteration.BatchOrderParallelDslExample"

# Sequential transfer processing — ForEach (sequential)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.iteration.SequentialTransferExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.iteration.SequentialTransferDslExample"

# Status polling — Loop (polling)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.iteration.StatusPollingExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.iteration.StatusPollingDslExample"

# Cursor pagination — Loop (pagination + carry)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.iteration.CursorPaginationExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.iteration.CursorPaginationDslExample"

# Exponential backoff retry — Loop (retry + carry)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.iteration.RetryWithBackoffExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.iteration.RetryWithBackoffDslExample"

# Logistics batch dispatch — composite (ForEach + Loop)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.iteration.LogisticsBatchDispatchExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.iteration.LogisticsBatchDispatchDslExample"
```

### Running Voice Agent examples

```bash
# basic voice processing pipeline
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.voice.VoicePipelineExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.voice.VoicePipelineDslExample"

# Multimodal interaction recording
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.voice.MultimodalInteractionExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.voice.MultimodalInteractionDslExample"

# intelligent voice contact center
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.customerservice.VoiceContactCenterExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.customerservice.VoiceContactCenterDslExample"

# voice banking
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.finance.VoiceBankingExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.finance.VoiceBankingDslExample"

# voice telemedicine
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.healthcare.VoiceTelemedicineExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.healthcare.VoiceTelemedicineDslExample"

# voice logistics dispatch
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.logistics.VoiceLogisticsDispatchExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.logistics.VoiceLogisticsDispatchDslExample"

# voice pronunciation tutoring
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.education.VoiceTutoringExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.education.VoiceTutoringDslExample"

# voice emergency dispatch
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.emergency.VoiceEmergencyDispatchExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.emergency.VoiceEmergencyDispatchDslExample"
```

### Running long-running examples (Long-Running wait/await)

```bash
# Customer service ticket timer approval (timer auto-close)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.longrunning.TicketApprovalLongRunningExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.longrunning.TicketApprovalLongRunningDslExample"

# E-commerce payment confirmation wait (event-correlation OR mode)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.longrunning.PaymentWaitExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.longrunning.PaymentWaitDslExample"

# Finance loan disbursement dual-event wait (AND mode)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.longrunning.LoanDisbursementWaitExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.longrunning.LoanDisbursementWaitDslExample"

# Logistics cargo readiness OR mode (first truck arrives)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.longrunning.CargoReadinessWaitExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.longrunning.CargoReadinessWaitDslExample"

# Healthcare patient consent signature deadline (timer + dual scenarios)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.longrunning.PatientConsentWaitExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.longrunning.PatientConsentWaitDslExample"

# Lambda collection operations order enrichment
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.longrunning.OrderEnrichmentLambdaDslExample"

# Chatbot — general customer service (Plan A)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.chatbot.CustomerServiceChatbotExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.chatbot.CustomerServiceChatbotDslExample"

# Chatbot — e-commerce shopping assistant (Plan A)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.chatbot.EcommerceChatbotExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.chatbot.EcommerceChatbotDslExample"

# Chatbot — IT helpdesk (Plan A)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.chatbot.ItHelpdeskChatbotExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.chatbot.ItHelpdeskChatbotDslExample"

# Chatbot — long-running customer service (Plan B: suspend/resume)
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.chatbot.CustomerServiceChatbotLongRunningExample"
mvn exec:java -pl bloge-examples \
  -Dexec.mainClass="com.leanowtech.bloge.examples.chatbot.CustomerServiceChatbotLongRunningDslExample"
```

### Expected output

Example output from `OrderProcessingExample`:

```
[START] Graph: orderProcess
  [→] fetchUser starting
  [→] fetchProducts starting
  [✓] fetchProducts completed in 82ms
  [✓] fetchUser completed in 55ms
  [→] calcPrice starting
  [✓] calcPrice completed in 55ms
  [→] checkCredit starting
  [✓] checkCredit completed in 86ms
  [→] createOrder starting
  [⊘] rejectOrder skipped: Conditional branch not taken from checkCredit
  [✓] createOrder completed in 86ms
[END] Graph: orderProcess (90ms, SUCCESS)
...
- **compile-scope**: `bloge-core`, `bloge-dsl`, `bloge-durable` (long-running examples)
