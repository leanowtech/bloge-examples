...
| `GP-04` | Tutorial Branch exact ref 和 TIMEOUT 摘要 | Branch isolation loader invariant | 可编辑 revision、保存、预检、恢复 | Correctness Owner | `NO_GO` |
...
| `NFR-05` | 404/400 有恢复动作且不丢内容 | Demo Pack 加载错误含重试 | 保存/冲突/离线状态未实现 | Frontend + API | `PARTIAL` |
