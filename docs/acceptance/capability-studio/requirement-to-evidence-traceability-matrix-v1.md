...
| `GP-08` | test/staging 提供 Canonical 9×3 开发批量端点 | 27 Run、逐 Case Oracle、同 Case fingerprint 稳定、零进程内外呼、两批并发隔离，以及独立 Test Kit 的严格 Schema/语义复验 | 受治理同闭包、五轴发布证据、部署级 egress、环境绑定和签署 | QA + Runtime | `PARTIAL` |
