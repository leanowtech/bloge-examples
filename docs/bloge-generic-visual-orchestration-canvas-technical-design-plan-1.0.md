...
- **Frontend:** routes `/showcase` + `/author`; React Flow typed handles + auto-layout; grouped+Cmd-K palette; candidate-prefetch highlight; Simulation tab + checklist; overlay + trace + mock badges; no governance panels.
