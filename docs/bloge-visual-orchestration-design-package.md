...
7. **Phase 1 核心闭环已经在 resource-gateway 内落地。**
   ...
   幂等返回之后，补跨 repository 事务/partial-failure 硬化、更广义 idempotency、
