...
的其他事务/partial-failure 硬化与跨系统/异步 runtime workflow 的更广义 idempotency，以及更深 SemVer/reimplementation 策略和更完整 JSON Schema 兼容性推理门禁。没有这些后续硬化，
