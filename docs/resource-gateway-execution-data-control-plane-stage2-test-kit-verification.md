...
This increment does not complete Stage 2. Public synchronous operator execution is now available,
but canvas integration, streaming/suspendable control and evidence, and physical runtime deployment
isolation remain open. The current
