...
aggregate health 亦已闭合；provider-confirmed cancellation/process isolation、signed dynamic resolver
inventory、durable 跨副本 cursor/sharding/fairness、多 lane Spring/capability 产品接线、publisher
...
跨 root-set recovery 的进程内强绑定 inventory/generation/fair-worker/scheduler/health runtime 已闭合；
企业 IAM/PDP、
provider-confirmed cancellation/process isolation、signed dynamic resolver inventory、durable 跨副本
cursor/sharding/fairness 与多 lane Spring/capability 产品接线、publisher mTLS/pinning、
