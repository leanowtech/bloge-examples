...
与全局压力观测已实现；claim-command token 加密/保留期、外部审批绑定、外部 WORM、runtime-state dispatch、排队/公平/优先级
...
仍缺 claim-command token 加密/保留期、外部审批/工单绑定、外部 alert routing、外部 WORM/
