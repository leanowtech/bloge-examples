...
数据库 revision floor 与全副本 inventory-generation 收敛已落地；动态 inventory
...
只输出 aggregate truth。动态 refresh/revoke、独立 signed witness、neutral cohort/crypto kernel、
