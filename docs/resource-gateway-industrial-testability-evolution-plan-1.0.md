...
transport、static Ed25519 trust、atomic dynamic JWKS、撤销传播、硬本地过期与 payload-free
刷新健康已落地；跨副本 generation convergence、signed witness 与 HA/chaos/外部 SLO 仍是下一增量。
