...
provider-confirmed cancellation/process isolation、默认 Spring recovery/publication 接线、跨 root-set
worker、publisher mTLS/pinning、response-key 热轮换、根源 anti-equivocation 与生产认证、HA/chaos/外部 SLO
仍待完成。
...
authenticated-conflict quarantine 已闭合；企业 IAM/PDP、provider-confirmed cancellation/process
isolation、默认 Spring recovery/publication 接线、跨 root-set worker、publisher mTLS/pinning、
...
worker、publisher mTLS/pinning、response-key 热轮换、外部审计、根源
