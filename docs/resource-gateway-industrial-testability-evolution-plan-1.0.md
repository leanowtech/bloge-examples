...
反熵循环处理。测试执行的即时四维配额已由独立 admission authority 执行；确定性候选临时退避与全局
压力观测已实现，永久 quarantine/dead-letter/人工处置、runtime-state dispatch、排队/公平/优先级
