...
不是 tenant weighting、priority/aging、公平队列或 poison-candidate quarantine/backoff。游标、
...
反熵循环处理。测试执行的即时四维配额已由独立 admission authority 执行；poison quarantine/backoff、
