...
闭合。bootstrap-root 轮换 ceremony、external non-equivocation、HA/chaos/外部 SLO 仍待完成。
...
database publication/witness floor、原子刷新与 HTTP 取密前后门禁现已闭合；neutral cohort/crypto kernel、
日常 runtime trust-root 已可无重启轮换；bootstrap-root ceremony、外部 non-equivocation、
