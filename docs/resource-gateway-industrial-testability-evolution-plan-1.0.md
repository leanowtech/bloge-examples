...
启用，production 仍无 bean。独立 test-kit、真实 IAM adapter、取消语义审计事件、fleet membership、poison
repair、非 H2/soak/chaos/DR 与 hard process cancellation 仍未闭合。验证见
