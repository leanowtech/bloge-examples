...
aggregate health，以及固定分区 durable cursor/sharding/cross-replica fairness 内核亦已闭合；
provider-confirmed cancellation/process isolation、signed dynamic resolver inventory、动态 rebalance、
多 lane Spring/capability 产品接线、publisher
