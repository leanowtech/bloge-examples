...
缺失时永久 `ACTIVE` 隔离。当前 bounded active/archive/event/snapshot retention 已落地；scheduler、
health/readiness/capability 与 source cycle/comparison/classification retention 仍未落地。冻结源码的完整
