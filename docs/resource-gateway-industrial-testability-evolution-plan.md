...
| 文档属性 | 内容 |
|---|---|
| 状态 | Accepted / In implementation；Stage 0/1 已落地，Stage 2 graph control plane、Java/JUnit/CI suite adapter、内置图 dogfooding 与 governed catalog materialization 已落地 |
...
当前严格验收基线：Resource Gateway `-Pfrontend clean verify` 共 1757 tests、0 failures、0 errors、
...
runner/protocol 增量聚焦 33 tests；built-in catalog materialization 增量聚焦 34 tests；suite consumer adapter 聚焦 21 tests、独立 test-kit
