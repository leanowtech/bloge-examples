...
已实现；命令/审批/历史保留期、外部审批绑定、外部 WORM、runtime-state dispatch、排队/
...
AES-GCM envelope、启动迁移和两阶段轮换保护 claim 精确重放副本。仍缺 active control fence hashing、
命令/审批/历史有界保留、外部审批/工单绑定、外部
