...
为一。staging 缺失签名清单会 fail startup，capability/health 只输出 aggregate truth。动态
refresh/revoke、独立 signed witness、neutral cohort/crypto kernel、KMS/HSM/mTLS/HA 与跨数据库/DR
认证仍是后续工作。验证见
