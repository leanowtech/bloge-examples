...
取密前后双门禁已落地；deployment-signed inventory、signed witness 与 HA/chaos/外部 SLO 仍是下一增量。
完整 Resource Gateway `clean verify` 执行 3127 tests，0 failures、0 errors、2 个条件浏览器跳过，
