...
> 增量部分取代。durable work registration/lifecycle 与 bounded one-shot worker 已闭合；仍待完成的是产品
> proof adapter、自主 scheduler、Spring test/staging composition、telemetry/health/capability、fairness/cohort、
