...
strict signed challenge-bound HTTPS transport 与 static Ed25519 trust 已落地；动态
trust/revocation、跨副本 generation convergence 与 HA/chaos/SLO 仍是下一增量。
完整 Resource Gateway `clean verify` 执行 3108 tests，0 failures、0 errors、2 个条件浏览器跳过，
