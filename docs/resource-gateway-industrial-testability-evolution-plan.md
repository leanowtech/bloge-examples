...
0 failures、0 errors、2 项既有浏览器环境跳过，并成功重打包 Spring Boot 可执行 JAR；bounded retention、
scheduler、health/readiness/capability 仍未落地，不能宣称 autonomously operated orphan reconciliation service。
