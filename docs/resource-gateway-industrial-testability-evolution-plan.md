...
maker/checker journal/coordinator 和自动 execution heartbeat/freeze 提交屏障现已闭合；企业 IAM/PDP、HSM/KMS custody、signer 强制 timeout/cancel、后台恢复
...
maker/checker journal/coordinator 和自动 execution heartbeat 已闭合；企业 IAM/PDP、signer 强制
timeout/cancel、后台恢复调度、发布失败对账、
