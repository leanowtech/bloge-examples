...
观测和 maker/checker approved discard 已实现；claim-command token 加密/保留期、外部审批绑定、外部 WORM、runtime-state dispatch、排队/
...
独立 approver group、单次审批原子消费、双人历史和 expired approval SLO。仍缺 claim-command token 加密/有界保留、外部审批/工单绑定、外部
