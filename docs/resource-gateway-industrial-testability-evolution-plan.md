...
submission，避免把 route existence 当成 runtime readiness。下一原子步为独立 test-kit client；真实 IAM
adapter、取消 semantic audit、fleet membership、poison repair、非 H2/soak/chaos/DR 与 hard process
cancellation 仍为硬缺口。验证见
