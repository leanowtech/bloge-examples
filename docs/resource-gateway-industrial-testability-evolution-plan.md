...
> mTLS 已闭合；表内旧的“publisher/读侧 mTLS/pinning 待完成”均已被本增量取代。自动证书/identity
> 轮换、HSM/KMS、根源 anti-equivocation 与生产数据库/HA/DR/chaos 认证仍未闭合，因此
