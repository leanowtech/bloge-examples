...
硬本地过期与 payload-free 刷新健康已落地；跨副本 generation convergence、signed witness 与
HA/chaos/外部 SLO 仍是下一增量。
完整 Resource Gateway `clean verify` 执行 3118 tests，0 failures、0 errors、2 个条件浏览器跳过，
