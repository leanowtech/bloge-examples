...
@BlogeOperator(
        ...
        promptHint = "Use after routing or classification when the flow should hand a "
                + "responder-ready draft and queue owner back to the application layer.",
        usageExample = """
                ...
                """,
        constraintsDescription = "queue and priorityScore should come from an upstream routing "
                + "step. VIP requests intentionally map to the dedicated vip-desk owner."
)
