...
class CustomerServiceSessionExampleTest {
    ...
    void javaApi_handoffPath_reachesSolveAndWrapUp() throws Exception {
        SessionStateSnapshot checkpoint = executeJavaApi("I need a refund and human support");
    ...
    void javaApi_closePath_skipsSolve() throws Exception {
        SessionStateSnapshot checkpoint = executeJavaApi("Thanks, bye");
        Map<String, Object> phaseOutputs = checkpoint.phaseOutputs();
    ...
    void dsl_handoffPath_reachesSolveAndWrapUp() throws Exception {
        SessionStateSnapshot checkpoint = executeDsl("I need a refund and human support");
        Map<String, Object> phaseOutputs = checkpoint.phaseOutputs();
    ...
    void dsl_closePath_skipsSolve() throws Exception {
        SessionStateSnapshot checkpoint = executeDsl("Thanks, bye");
        Map<String, Object> phaseOutputs = checkpoint.phaseOutputs();
    ...
    private SessionStateSnapshot executeJavaApi(String userMessage) throws Exception {
    ...
    private SessionStateSnapshot executeDsl(String userMessage) throws Exception {
        ExampleSessionSnapshotStore store = new ExampleSessionSnapshotStore();
