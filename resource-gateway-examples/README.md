...
the browser workflow covers these dynamic `additionalProperties` picker bindings
through generated DSL and saved/exported draft bundles.
...
The test suite is organised into four layers (61 test report classes, 707 executed
