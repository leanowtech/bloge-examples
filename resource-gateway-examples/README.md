...
`resource:` namespace, imported operators that claim system-managed source kinds
such as resource descriptors, published visual graphs, or Java runtime operators,
empty libraries, duplicate port names, unsupported
...
The test suite is organised into four layers (63 test report classes, 758 executed
