...
selection becomes the node output port, and runtime lowering injects the
...
and environment. Dragging that operator into another visual draft lowers to the
