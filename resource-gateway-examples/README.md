...
input schema path fields, context/node binding path segments, native config keys,
...
The test suite is organised into four layers (63 test report classes, 746 executed
