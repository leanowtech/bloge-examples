...
diagnostics back to the affected canvas node, inspect validation diagnostics and
active replay trace attribution for the selected node directly in the operator
