...
field names, native config keys and authored `bloge:transform` assignment keys
must be DSL-safe field identifiers; validation/codegen return structured
