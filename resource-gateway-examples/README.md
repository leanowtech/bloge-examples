...
clients store bindings without collapsing distinct port targets.
...
the browser workflow covers these dynamic `additionalProperties` and
`patternProperties` picker bindings through generated DSL and saved/exported
draft bundles.
...
The test suite is organised into four layers (61 test report classes, 708 executed
