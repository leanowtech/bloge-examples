...
validation/profile/impact result, so user-provided schema-only operator catalogs
can be reviewed or moved across environments as first-class artifacts.
