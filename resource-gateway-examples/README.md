...
and secret-bound operators before importing it into the catalog, validate
...
The test suite is organised into four layers (67 test report classes, 876 executed
