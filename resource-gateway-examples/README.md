...
paths lower to BLOGE bracket expressions such as `ctx.scores[0]` and
`node.output.items[0]`, keeping canvas validation, generated DSL, and runtime
execution aligned.
...
schemas and transform assignment targets, returning
...
The test suite is organised into four layers (62 test report classes, 737 executed
