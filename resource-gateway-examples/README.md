...
full golden suite for the selected publication. A successful suite can also be
...
new or edited golden case or assertion immediately invalidates old certification
evidence.
...
The test suite is organised into four layers (61 test report classes, 698 executed
