...
authored `bloge:transform` assignment keys, and decision-table input/output keys must be
DSL-safe field identifiers; validation/codegen return structured
...
The test suite is organised into four layers (61 test report classes, 688 executed
