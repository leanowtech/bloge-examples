...
const AUTO_LAYOUT_NODE_ROW_GAP = 48;
const AUTO_LAYOUT_MIN_COLUMN_GAP = 148;
// Must match the two-sided 24px card clearance enforced by constrainCanvasLayout.
const AUTO_LAYOUT_SMALL_GRAPH_COLUMN_GAP = 48;
