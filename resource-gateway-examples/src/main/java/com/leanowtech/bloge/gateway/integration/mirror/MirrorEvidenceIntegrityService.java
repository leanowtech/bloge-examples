...
public final class MirrorEvidenceIntegrityService {
    ...
    public Verification verify(MirrorEvidenceBundle bundle) {
        if (bundle == null || !MirrorEvidenceBundle.SCHEMA_VERSION.equals(bundle.schemaVersion())
                ...
                bundle.schemaVersion())
                && !MirrorEvidenceBundle.WRITE_OUTCOME_SCHEMA_VERSION.equals(
                bundle.schemaVersion())) {
            ...
            switch (evidence.stateEvidence()) {
                ...
                case MirrorStateTransitionRunEvidence readWrite ->
                        MirrorStateTransitionRunEvidenceIntegrity.verify(
                                mapper, readWrite);
                case MirrorStateWriteOutcomeRunEvidence writeOutcome ->
    ...
    private String signatureMaterialFingerprint(
        ...
        String domain = switch (schemaVersion) {
            ...
            case MirrorEvidenceAttestation.WRITE_OUTCOME_SCHEMA_VERSION ->
                    SIGNATURE_DOMAIN_V5;
    ...
    private static String attestationVersion(
        ...
        return switch (evidenceVersion) {
            ...
            case MirrorRunEvidence.WRITE_OUTCOME_SCHEMA_VERSION ->
                    MirrorEvidenceAttestation.WRITE_OUTCOME_SCHEMA_VERSION;
