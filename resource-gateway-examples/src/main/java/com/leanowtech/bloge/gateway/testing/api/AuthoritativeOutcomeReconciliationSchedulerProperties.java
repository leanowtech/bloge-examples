...
/**
 * Strict process-local configuration for autonomous authoritative outcome reconciliation.
 *
 * <p>Scheduling is disabled by default and may target only one exact partition in the physically
 * non-production Mirror runtime. Database policy remains authoritative for cross-replica
 * uniqueness, leases, retries, and revision fencing.</p>
 *
...
public record AuthoritativeOutcomeReconciliationSchedulerProperties(
        Boolean enabled,
        String instanceId,
        String region,
    ...
    public static final String PREFIX =
            "gateway.testing.mirror.outcome-reconciliation.scheduler";
    ...
    public AuthoritativeOutcomeReconciliationSchedulerProperties {
        ...
        if (enabled) {
            ...
            if (RESERVED_PRODUCTION_ENVIRONMENTS
                ...
                throw new IllegalArgumentException(
                        "Enabled outcome scheduler cannot target a reserved production environment");
            }
        }
    }
