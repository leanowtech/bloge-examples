...
/**
 * Verifies one atomic dual-quorum serving-inventory trust-root publication.
 *
 ...
 */
public final class ConfiguredTestSuiteStabilityServingInventoryTrustRootAuthority {
    ...
    private final TestSuiteStabilityServingInventoryTrustRootPublication publication;
        ...
        public ExpectedBinding {
            ...
            if (!IDENTIFIER.matcher(scopeId).matches()
                ...
                throw new IllegalArgumentException(
                        "Serving-inventory trust-root binding is invalid");
            }
        }
    }
     ...
     */
    public ConfiguredTestSuiteStabilityServingInventoryTrustRootAuthority(
        ...
        TestSuiteStabilityServingInventoryTrustRootFloor durableFloor =
                Objects.requireNonNull(floor, "floor");
        if (!durableFloor.durable()) {
            throw new IllegalArgumentException(
                    "Serving-inventory trust-root publication requires a durable floor");
        }
        this.publication = Objects.requireNonNull(publication, "publication");
        TestSuiteStabilityServingInventoryTrustRootPublication.Material material =
        ...
        if (!this.publication.fingerprintVerified(mapper)
            ...
            throw new IllegalArgumentException(
                    "Serving-inventory trust-root publication binding is invalid");
        }
        ...
        if (lifetime.isZero() || lifetime.isNegative()
            ...
            throw new IllegalArgumentException(
                    "Serving-inventory trust-root publication time is invalid");
        }
        ...
        durableFloor.accept(new TestSuiteStabilityServingInventoryTrustRootFloor.Generation(
     ...
     */
    public static ConfiguredTestSuiteStabilityServingInventoryTrustRootAuthority fromJson(
            ObjectMapper objectMapper,
            Clock clock,
            ExpectedBinding binding,
            Set<String> acceptedPolicyFingerprints,
        ...
        try {
            ...
            return new ConfiguredTestSuiteStabilityServingInventoryTrustRootAuthority(
            ...
            throw new IllegalArgumentException(
                    "Serving-inventory trust-root configuration is invalid", invalid);
        }
    }

    static TestSuiteStabilityServingInventoryTrustRootPublication parsePublication(
            ObjectMapper strict, String publicationJson) throws java.io.IOException {
        return strict.readValue(normalized(publicationJson),
                TestSuiteStabilityServingInventoryTrustRootPublication.class);
    }
    ...
    VerifiedKeySet verifiedKeySet() {
        if (!snapshot().available()) {
            throw new IllegalStateException(
                    "Serving-inventory trust-root key set is unavailable");
        }
    ...
    private static List<ConfiguredTestSuiteStabilityServingInventoryAuthority.AuthorityKey>
            parseKeys(List<TestSuiteStabilityServingInventoryTrustRootPublication.AuthorityKeyMaterial>
            materials) {
        List<ConfiguredTestSuiteStabilityServingInventoryAuthority.AuthorityKey> result =
                new ArrayList<>();
        for (TestSuiteStabilityServingInventoryTrustRootPublication.AuthorityKeyMaterial material
                : materials) {
            try {
                ...
                throw new IllegalArgumentException(
                        "Serving-inventory trust-root public key is invalid", invalid);
            }
        }
    ...
    private static Set<String> acceptedPolicies(Set<String> values) {
        ...
        for (String value : values == null ? Set.<String>of() : values) {
            ...
            if (!FINGERPRINT.matcher(normalized).matches() || !result.add(normalized)) {
                throw new IllegalArgumentException(
                        "Serving-inventory trust-root policy is invalid");
            }
        }
        if (result.isEmpty() || result.size() > 32) {
            throw new IllegalArgumentException(
                    "One through 32 serving-inventory trust-root policies are required");
        }
    ...
    public record Snapshot(
        ...
        public static final String SCHEMA_VERSION =
                "bloge.testSuiteStabilityServingInventoryTrustRootSnapshot.v1";
        ...
        public Snapshot {
            ...
            if (!SCHEMA_VERSION.equals(schemaVersion) || status.isBlank() || sequence < 1
                ...
                throw new IllegalArgumentException(
                        "Serving-inventory trust-root snapshot is invalid");
            }
        }
    }
