...
public record ExternalSequenceAnchorBootstrapRootGenesis(
    ...
    /** Maximum threshold representable by each transition signature list. */
    public static final int MAXIMUM_SIGNATURE_THRESHOLD = 32;
    ...
    public ExternalSequenceAnchorBootstrapRootGenesis {
        ...
        if (!SCHEMA_VERSION.equals(schemaVersion)
                ...
                || signatureThreshold > MAXIMUM_SIGNATURE_THRESHOLD
