...
/** Aggregate-only Actuator health for the recovery-fleet external non-equivocation quorum. */
public final class ExternalSequenceAnchorBootstrapRootRecoveryFleetExternalSequenceAnchorHealth
        implements HealthIndicator {

    private final ExternalSequenceAnchorBootstrapRootRecoveryFleetExternalSequenceAnchor anchor;

    /**
     * Creates a projection without endpoint, stream, challenge, fingerprint, authority, or key data.
     *
     * @param anchor recovery-fleet external non-equivocation authority
     */
    public ExternalSequenceAnchorBootstrapRootRecoveryFleetExternalSequenceAnchorHealth(
