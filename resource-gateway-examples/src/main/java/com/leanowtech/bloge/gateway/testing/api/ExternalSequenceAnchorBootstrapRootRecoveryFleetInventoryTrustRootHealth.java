...
/**
 * Aggregate-only Actuator health for managed recovery-fleet inventory runtime verification keys.
 *
 ...
 */
public final class ExternalSequenceAnchorBootstrapRootRecoveryFleetInventoryTrustRootHealth implements HealthIndicator {

    private final DynamicExternalSequenceAnchorBootstrapRootRecoveryFleetInventoryTrustRootAuthority authority;
     ...
     */
    public ExternalSequenceAnchorBootstrapRootRecoveryFleetInventoryTrustRootHealth(
            DynamicExternalSequenceAnchorBootstrapRootRecoveryFleetInventoryTrustRootAuthority authority) {
    ...
    public Health health() {
        try {
            DynamicExternalSequenceAnchorBootstrapRootRecoveryFleetInventoryTrustRootAuthority.Snapshot snapshot =
                    authority.snapshot();
