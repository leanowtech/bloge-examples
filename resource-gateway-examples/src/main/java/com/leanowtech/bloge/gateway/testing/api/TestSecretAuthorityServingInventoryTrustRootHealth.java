 ...
 */
public final class TestSecretAuthorityServingInventoryTrustRootHealth implements HealthIndicator {

    private final DynamicTestSecretAuthorityServingInventoryTrustRootAuthority authority;
     ...
     */
    public TestSecretAuthorityServingInventoryTrustRootHealth(
    ...
    public Health health() {
        try {
            DynamicTestSecretAuthorityServingInventoryTrustRootAuthority.Snapshot snapshot =
                    authority.snapshot();
