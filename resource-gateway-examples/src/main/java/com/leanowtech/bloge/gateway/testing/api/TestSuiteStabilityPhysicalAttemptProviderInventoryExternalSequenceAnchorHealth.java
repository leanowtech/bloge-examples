...
/** Aggregate-only Actuator health for physical provider-inventory non-equivocation. */
public final class
    ...
    /**
     * Creates a projection without endpoint, stream, challenge, fingerprint, authority, or key.
     *
     * @param anchor physical provider-inventory external sequence authority
     */
    public TestSuiteStabilityPhysicalAttemptProviderInventoryExternalSequenceAnchorHealth(
            TestSuiteStabilityPhysicalAttemptProviderInventoryExternalSequenceAnchor anchor) {
        this.anchor = Objects.requireNonNull(anchor, "anchor");
    }

    /** Returns UP only after the latest external operation achieved a valid quorum. */
    @Override
