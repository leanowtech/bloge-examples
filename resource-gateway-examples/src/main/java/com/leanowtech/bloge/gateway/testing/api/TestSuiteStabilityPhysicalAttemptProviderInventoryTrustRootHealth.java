...
/**
 * Aggregate-only Actuator health for managed physical provider-inventory runtime verification keys.
 *
 ...
 */
public final class TestSuiteStabilityPhysicalAttemptProviderInventoryTrustRootHealth implements HealthIndicator {

    private final DynamicTestSuiteStabilityPhysicalAttemptProviderInventoryTrustRootAuthority authority;
     ...
     */
    public TestSuiteStabilityPhysicalAttemptProviderInventoryTrustRootHealth(
            DynamicTestSuiteStabilityPhysicalAttemptProviderInventoryTrustRootAuthority authority) {
    ...
    public Health health() {
        try {
            DynamicTestSuiteStabilityPhysicalAttemptProviderInventoryTrustRootAuthority.Snapshot snapshot =
                    authority.snapshot();
