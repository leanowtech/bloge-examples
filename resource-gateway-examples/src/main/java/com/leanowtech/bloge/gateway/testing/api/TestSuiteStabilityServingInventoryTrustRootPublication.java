...
/**
 * Dual-quorum signed publication of serving-inventory publication and witness verification keys.
 *
 ...
 */
public record TestSuiteStabilityServingInventoryTrustRootPublication(
    ...
    public static final String SCHEMA_VERSION =
            "bloge.testSuiteStabilityServingInventoryTrustRootPublication.v1";

    private static final Pattern FINGERPRINT = Pattern.compile("sha256:[a-f0-9]{64}");

    /** Rejects partial, unbounded, non-canonical, or authority-duplicated envelopes. */
    public TestSuiteStabilityServingInventoryTrustRootPublication {
    ...
    public record Material(
        ...
        public static final String SCHEMA_VERSION =
                "bloge.testSuiteStabilityServingInventoryTrustRootMaterial.v1";
