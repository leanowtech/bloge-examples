...
public final class LoanDecisionReferenceCandidateContributor implements ReferenceCandidateContributor {
    ...
    public List<ReferenceCandidate> contribute(ReferenceScope scope) {
        return List.of(
                ...
                candidate(scope, "CONTRACT", "loan-decision-contract-v1", "Loan decision package contract",
                ...
                candidate(scope, "EFFECT_CONTRACT", "loan-decision-effect-v1", "Loan decision effect model",
                ...
                candidate(scope, "AGENT", "loan-policy-agent", "Loan policy service carrier",
                        "Service carrier that presents the verified decision solution to support channels.",
                        List.of("agent", "service-carrier")),
                candidate(scope, "CHANNEL_APPLICATION", "customer-support-chat", "Customer support chat",
                ...
                candidate(scope, "DOMAIN_FIDELITY_INVENTORY", "loan-policy-fidelity", "Loan policy fidelity inventory",
