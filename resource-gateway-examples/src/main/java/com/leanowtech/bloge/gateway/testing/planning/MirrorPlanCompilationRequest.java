 ...
 * @param corpusPayloads exact governed recorded corpus outcomes
...
public record MirrorPlanCompilationRequest(
    ...
    public MirrorPlanCompilationRequest {
        ...
        corpusPayloads = corpusPayloads == null
    ...
    /** Backward-compatible constructor for requests without a governed corpus snapshot. */
    public MirrorPlanCompilationRequest(
            String planId,
            Graph graph,
            String graphArtifactFingerprint,
            ...
            Instant compiledAt,
            Instant expiresAt) {
        this(planId, graph, graphArtifactFingerprint, capabilityClosure,
                fixtureBundle, replayPayloads, ResolvedCorpusPayloads.empty(),
                policy, scenarioPackRef, compiledAt, expiresAt);
    }
