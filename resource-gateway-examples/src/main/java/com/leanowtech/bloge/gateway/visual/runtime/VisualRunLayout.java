...
/**
 * Presentation-only layout returned with a visual graph run.
 *
 * <p>The shape intentionally matches the existing browser layout JSON contract while living in the
 * visual runtime boundary instead of the resource-gateway showcase package.</p>
 *
 * @param schemaVersion versioned layout contract identifier
 * @param rootId graph name
 * @param executionMode execution-mode family
 * @param nodes visual nodes
 * @param edges visual edges
 * @param groups optional visual groups
 * @param viewport initial canvas viewport
 */
public record VisualRunLayout(
    ...
    /**
     * Visual node in a generated diagram.
     *
     * @param id node identifier from the BLOGE graph
    ...
    /**
     * Visual edge in a generated diagram.
     *
    ...
    /**
     * Optional grouping hint used by browser diagrams.
     *
