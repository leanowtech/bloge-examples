    ...
    public record Standin(
        ...
        public Standin(String originalNodeId, String rewrittenOperatorRef,
            ...
            this(originalNodeId, rewrittenOperatorRef, output, expectedInput,
                    ResourceFidelity.OUTPUT_LEVEL, null);
        }

        /** Backward-compatible stand-in constructor without an advanced dependency behavior. */
        public Standin(String originalNodeId, String rewrittenOperatorRef,
                       Object output, Object expectedInput, ResourceFidelity resourceFidelity) {
