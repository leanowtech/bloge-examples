...
class TestSuiteStabilityCrossRetentionTrendControllerTest {
    @Test
    void endpointBindsCursorHeadPinAndDedicatedTrendReadAuthority() throws Exception {
        TestSuiteStabilityCrossRetentionTrendAnalysisService service =
                mock(TestSuiteStabilityCrossRetentionTrendAnalysisService.class);
    ...
    @Test
    void unrelatedReadPurposeCannotReachPreviewService() throws Exception {
        TestSuiteStabilityCrossRetentionTrendAnalysisService service =
                mock(TestSuiteStabilityCrossRetentionTrendAnalysisService.class);
    ...
    private static MockMvc mvc(
        ...
        return MockMvcBuilders.standaloneSetup(
                        new TestSuiteStabilityCrossRetentionTrendController(
    ...
    private static String request() {
        return """
                {"schemaVersion":"bloge.testSuiteStabilityCrossRetentionTrendAnalysisRequest.v1",
                 ...
                 "afterSequence":40,"minimumRuns":3,"maximumRuns":20,
                 "expectedHeadFingerprint":"sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"}
                """;
    }
