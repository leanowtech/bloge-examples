...
class TestSuiteStabilityObservationLedgerLifecycleArchiveControllerTest {
    @Test
    void dedicatedV2EndpointBindsPinsAndTrendReadAuthority() throws Exception {
        TestSuiteStabilityObservationLedgerLifecycleArchivePageService service =
                mock(TestSuiteStabilityObservationLedgerLifecycleArchivePageService.class);
    ...
    @Test
    void unrelatedReadPurposeCannotReachV2Assembler() throws Exception {
        TestSuiteStabilityObservationLedgerLifecycleArchivePageService service =
                mock(TestSuiteStabilityObservationLedgerLifecycleArchivePageService.class);
    ...
    private static MockMvc mvc(
        ...
        return MockMvcBuilders.standaloneSetup(
                        new TestSuiteStabilityObservationLedgerLifecycleArchiveController(
