...
class VisualLibraryAuthoringAdminControllerTest {
    ...
    void parsesSignaturesAndAdvertisesExactStageZeroCapabilities() throws Exception {
        ...
        mockMvc.perform(get("/admin/visual-operator-library-authoring/catalogs"))
                ...
                .andExpect(jsonPath("$.features.unifiedDiscoveryFacts").value(true))
                .andExpect(jsonPath("$.features.runtimeParity").value(true))
                .andExpect(jsonPath("$.features.frameworkFunctionInventory").value(true))
                ...
                .andExpect(jsonPath("$.limits.maximumDiscoverySourceBytes").value(10485760))
