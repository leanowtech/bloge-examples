 ...
 * Gateway response. Capability-mirror consumers can additionally negotiate the packaged Stage 0
 * compatibility baseline and verify content-addressed snapshot closures without server classes.</p>
 */
