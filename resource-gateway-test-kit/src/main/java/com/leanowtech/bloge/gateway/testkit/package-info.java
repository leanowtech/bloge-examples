 ...
 * offline evidence and exact-inventory rollout verifiers whose trust anchors are supplied by the
 * caller rather than inferred from the Resource Gateway response.</p>
 */
