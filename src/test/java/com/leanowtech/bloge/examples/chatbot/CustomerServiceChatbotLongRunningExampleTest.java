...
class CustomerServiceChatbotLongRunningExampleTest {
    ...
    private GraphResult executeJavaApi(String userMessage) throws Exception {
        ...
        ExecutionListener listener = new ExecutionListener() {
            ...
            @Override
            public void onNodeSuspended(String graphName, String nodeId, String key) {
                if ("awaitUserInput".equals(nodeId)) suspended.countDown();
            }
        };
        ...
        var ctx = new GraphContext(Map.of("sessionId", "SESSION-LR-TEST-001"));
        ...
        engine.signal(execId, "awaitUserInput",
                new UserMessagePayload(userMessage, "SESSION-LR-TEST-001"));
    ...
    void testJavaApi_complaintIntent_routesToComplaintHandler() throws Exception {
        GraphResult result = executeJavaApi("I want to make a complaint about this");
    ...
    private GraphResult executeDsl(String userMessage) throws Exception {
        ...
        var engine = GraphEngine.builder()
                ...
                .listeners(List.of(listener))
                .build();
        var ctx = new GraphContext(Map.of("sessionId", "SESSION-LR-DSL-TEST-001"));
        ...
        engine.signal(execIdRef.get(), "awaitUserInput",
                Map.of("userMessage", userMessage, "sessionId", "SESSION-LR-DSL-TEST-001"));
